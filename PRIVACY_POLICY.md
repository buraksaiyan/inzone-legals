...
- Secure device storage for authentication tokens where available
- Password hashing by our authentication provider
- Database row-level access controls tied to account identity
- Restricted server functions and authenticated data access

No service can guarantee absolute security. You are responsible for protecting permanent account credentials and device access.

---

## 9. Retention and Deletion

Data is retained while your account remains active and as needed for security, legal, backup, and service-continuity purposes.
